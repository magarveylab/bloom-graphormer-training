...
def compile_model(
    pytorch_checkpoint_fp: str = f"{experiment_dir}/bloom-lnk/checkpoints/last.pt",
    torchscript_dir: str = f"{experiment_dir}/bloom-lnk/torchscript",
...
parser = argparse.ArgumentParser(
    description="Convert Bloom-LNK to torchscript format"
)
parser.add_argument(
    "-torchscript_dir",
    help="Directory to save torchscript models",
    default=f"{experiment_dir}/bloom-lnk/torchscript",
)
parser.add_argument(
    "-pytorch_checkpoint_fp",
    help="Pytorch checkpoint file path",
    default=f"{experiment_dir}/bloom-lnk/checkpoints/last.pt",
)
