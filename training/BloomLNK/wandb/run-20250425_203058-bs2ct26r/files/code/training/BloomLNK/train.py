...
from DataModule import LNKDataModule
...
def train(
    checkpoint_dir: str = f"{experiment_dir}/bloom-lnk/checkpoints",
    checkpoint_name: str = "bloom-lnk-{epoch:02d}-{val_loss:.2f}",
    logger_entity: str = "magarvey",
    logger_name: str = "bloom-lnk",
    ...
    # data module
    dm = LNKDataModule(
        graph_dir="/home/gunam/storage/workspace/bearlinker_workspace/zenodo/e2"
    )
...
parser = argparse.ArgumentParser(
    description="Train Bloom-LNK to associate molecules and bgcs"
)
parser.add_argument(
    "-checkpoint_dir",
    help="Directory to save checkpoints",
    default=f"{experiment_dir}/bloom-lnk/checkpoints",
)
parser.add_argument(
    "-checkpoint_name",
    help="checkpoint name for wandb",
    default="bloom-lnk-{epoch:02d}-{val_loss:.2f}",
)
parser.add_argument(
    "-logger_entity",
    help="wandb entity",
