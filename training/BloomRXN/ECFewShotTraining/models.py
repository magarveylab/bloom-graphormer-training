...
def get_model(
    ...
    train_metrics = ModuleDict(
        {
            ...
            # input b
            "ec1___b": ClassificationMetrics.get(
                name="ec1___b_train",
                num_classes=len(ec1_dict),
                task="multiclass",
            ),
            "ec2___b": ClassificationMetrics.get(
                name="ec2___b_train",
                num_classes=len(ec2_dict),
                task="multiclass",
            ),
            "ec3___b": ClassificationMetrics.get(
                name="ec3___b_train",
                num_classes=len(ec3_dict),
                task="multiclass",
            ),
            # siamese cls
            "pair_match___a___b": ClassificationMetrics.get(
                name="pair_match___a___b_train",
                num_classes=2,
                task="multiclass",
            ),
        }
    ...
    val_metrics = ModuleDict(
        {
            ...
            # siamese cls
            "pair_match___a___b": ClassificationMetrics.get(
                name="pair_match___a___b_val", num_classes=2, task="multiclass"
            ),
        }
    )
    ...
    states = torch.load(pretrained_checkpoint_fp)
