...
def train(
    checkpoint_dir: str = f"{experiment_dir}/bloom-bgc-mlm/checkpoints",
    checkpoint_name: str = "bloom-bgc-mlm-{epoch:02d}-{val_loss:.2f}",
    logger_entity: str = "magarvey",
    logger_name: str = "bloom-bgc-mlm",
...
parser = argparse.ArgumentParser(
    description="Train Bloom-BGC with MLM to learn biosynthetic context"
)
parser.add_argument(
    "-checkpoint_dir",
    help="Directory to save checkpoints",
    default=f"{experiment_dir}/bloom-bgc-mlm/checkpoints",
)
parser.add_argument(
    "-checkpoint_name",
    help="checkpoint name for wandb",
    default="bloom-bgc-mlm-{epoch:02d}-{val_loss:.2f}",
)
parser.add_argument(
    "-logger_entity",
    help="wandb entity",
