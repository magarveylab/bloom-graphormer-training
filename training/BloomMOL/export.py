...
parser = argparse.ArgumentParser(
    description="Convert Bloom-MOL model to torchscript format"
)
parser.add_argument(
    "-torchscript_dir",
    help="Directory to save torchscript models",
    default=f"{experiment_dir}/bloom-mol-mlm/torchscript",
)
parser.add_argument(
    "-pytorch_checkpoint_fp",
    help="Pytorch checkpoint file path",
    default=f"{experiment_dir}/bloom-mol-mlm/checkpoints/last.pt",
)
